...
def check():  # check if a win case exists
    ...
    flag = flag + 1
    if (
        b1 == b2 and b1 == b3 and b1 == "O"
    ) or (
        b1 == b2 and b1 == b3 and b1 == "X"
    ):
        win(btn1["text"])
    if (
        b4 == b5 and b4 == b6 and b4 == "O"
    ) or (
        b4 == b5 and b4 == b6 and b4 == "X"
    ):
        win(btn4["text"])
    if (
        ...
        win(btn7["text"])
    if (
        b1 == b4 and b1 == b7 and b1 == "O"
    ) or (
        b1 == b4 and b1 == b7 and b1 == "X"
    ):
        win(btn1["text"])
    if (
        b2 == b5 and b2 == b8 and b2 == "O"
    ) or (
        b2 == b5 and b2 == b8 and b2 == "X"
    ):
        win(btn2["text"])
    if (
        ...
        win(btn3["text"])
    if (
        b1 == b5 and b1 == b9 and b1 == "O"
    ) or (
        b1 == b5 and b1 == b9 and b1 == "X"
    ):
        win(btn1["text"])
    if (
        b7 == b5 and b7 == b3 and b7 == "O"
    ) or (
        b7 == b5 and b7 == b3 and b7 == "X"
    ):
        win(btn7["text"])
    if flag == 10:
...
reset_btn = Button(window, text="Reset", bg="red", fg="white", font=('Helvetica', '12'), command=reset_game)
